...
function inputCardNum(){
    ...
    //change card number input to formatted version
    if(cardNumberInput.value !== formattedCardNumber){
...
function inputMM(){
    ...
    formattedMM = formattedMM.replace(/[^\d]/g,"");
...
function inputYY(){
    ...
    formattedYY = formattedYY.replace(/[^\d]/g,"");
...
function inputCvc(){
    ...
    formattedCvc = formattedCvc.replace(/[^\d]/g,"");
